...
to setup
  ...
  ;set image bitmap:import "singletongraphic.png"
  bitmap:copy-to-drawing (bitmap:scaled (bitmap:import "data/singletongraphic.png") 1366 576) -150 0
  ;bitmap:copy-to-drawing image 0 0
  ;bitmap:import "singletongraphic.bmp"
  ;(bitmap:scaled (bitmap:import "singletongraphic.png") 400 100)
  ;import-pcolors-rgb "singletongraphic.bmp"
...
to load
  let view1 gis:load-dataset "data/roads-line.shp"
  ;gis:set-world-envelope gis:envelope-of view1
  gis:raster-world-envelope [151.1535 151.2407 -32.5871 -32.5459]
